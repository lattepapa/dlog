...
var _a = require("gatsby/graphql"), introspectionQuery = _a.introspectionQuery, graphql = _a.graphql, buildClientSchema = _a.buildClientSchema, parse = _a.parse, printSchema = _a.printSchema;
var path = require("path");
var defaultLocation = path.resolve(process.cwd(), "graphql-types.d.ts");
exports.onPostBootstrap = function (args, options, callback) {
    if (options === void 0) { options = { plugins: [] }; }
    return __awaiter(void 0, void 0, void 0, function () {
        var store, reporter, dest, schema, res, introspectSchema, parsedSchema, config, output;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    parsedSchema = parse(printSchema(buildClientSchema(introspectSchema)));
                    config = {
                        // documents,
                        documents: [],
                        config: {},
